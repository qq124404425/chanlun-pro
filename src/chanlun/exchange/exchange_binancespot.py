...
class ExchangeBinanceSpot(Exchange):
    ...
    def __init__(self):
        ...
        self.db_exchange = ExchangeDB('spot')
    ...
    def online_klines(self, code: str, frequency: str,
        ...
        if start_date is None and end_date is None:
            ...
            kline = self.exchange.fetch_ohlcv(symbol=code, timeframe=frequency_map[frequency], limit=1000, params=params)
...
if __name__ == '__main__':
    ...
    klines = ex.klines('BTC/USDT', '30m', start_date='2000-01-01 00:00:00', end_date='2023-11-20 00:00:00')
    print(klines.tail())
